...
describe('MyAssetContract-demo-contract@0.0.2' , () => {
    ...
    describe('readMyAsset', () => {
        it('should submit readMyAsset transaction', async () => {
            ...
            const response: Buffer = await SmartContractUtil.submitTransaction('MyAssetContract', 'readMyAsset', args, gateway);
            // submitTransaction returns buffer of transcation return value
            // TODO: Update with return value of transaction
            assert.equal(true, true);
            // assert.equal(JSON.parse(response.toString()), undefined);
    ...
    describe('queryAllAssets', () => {
        it('should submit queryAllAssets transaction', async () => {
            ...
            const response: Buffer = await SmartContractUtil.submitTransaction('MyAssetContract', 'queryAllAssets', args, gateway);
            // submitTransaction returns buffer of transcation return value
            // TODO: Update with return value of transaction
            assert.equal(true, true);
            // assert.equal(JSON.parse(response.toString()), undefined);
